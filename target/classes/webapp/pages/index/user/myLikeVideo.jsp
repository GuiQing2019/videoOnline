    ...
    <div class="main-content">
            ...
            <nav class="navbar navbar-default w3_megamenu" role="navigation">
                ...
                <div id="defaultmenu" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a id="fd"
                                              href="/page/myLikeVideo?id=${sessionScope.tbSysuser.userId}">我点赞的</a></li>
                                                ...
                                                <c:forEach var="tbVideos" items="${videoList}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" onclick="y('${tbVideos.videoId}',this)">
                                                                移出点赞
                                                            </button>
        ...
        <script type="text/javascript">
            ...
            function y(vid, obj) {
                ...
                $.ajax({
                    type: "post",
                    url: "/VideoController/delLikeVideo",
                    data: {
                        id: vid
                    },
                    async: false,
