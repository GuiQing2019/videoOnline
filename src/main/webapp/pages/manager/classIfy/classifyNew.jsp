        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4><b><i>新增分类</i></b></h4></div>
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form id="classifyInsert" action="/manager/classifyManager/classifyInsert"
                                                      method="post">
                                                    <table style=" margin:50px auto;">
                                                        <tbody>
                                                        <tr>
                                                            <td>类型名称：</td>
                                                            <td><input type="text" class="form-control" name="classifyName"
                                                                       value="${roleIList.classifyName}" required/></td>
                                                        </tr>
                                                        <tr>
                                                            <td>类型解释：</td>
                                                            <td><input type="text" class="form-control" name="classifyDesc"
                                                                       value="${roleIList.classifyDesc}" required/></td>
                                                        </tr>
                                                        </tbody>
...
<script type="text/javascript">
    ...
    //通过ajax对接服务器
    $("#classifyInsert").ajaxForm({
        beforeSubmit: function () {
        },
        data: $("#classifyInsert").serialize(),
        dataType: "json",
        success: function (data) {
            ...
            if (data.code == 0) {
                ...
                //添加成功成功
                alert(data.msg);
                window.location.href = "/manager/classifyNew";
            } else {
                //添加失败
                alert(data.msg)
            }
